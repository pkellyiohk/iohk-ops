...
in lib // (rec {
  ...
  devKeys = [ domenKey alanKey jakeKey dshevchenkoKey larsKey philippKey kosergeKey ksaric sectore michaelKey patrickKey akegaljKey alfredoKey rodneyKey vasilisKey andreasKey samKey alexandersKey ];
